...
contract StakingValidatorRegistry is StakingStorageLayout, RetryMixin, IStakingValidatorRegistry {
    ...
    function registerValidator(address validatorAddress, uint16 commissionRate) payable external  {
    ...
    function addValidator(address account) external onlyFromGovernance virtual  {
