...
contract ChainConfig is InjectorContextHolder, IChainConfig {
    ...
    function initialize(
        ...
        _consensusParams.candidateLength = candidateLength;
        ...
        _consensusParams.maxDelegateTotalAmount = maxDelegateTotalAmount;
        emit MaxDelegateTotalAmountChanged(0, maxDelegateTotalAmount);
    }
    ...
    function getCandidateLength() external view override returns (uint32) {
        return _consensusParams.candidateLength;
    }

    function setCandidateLength(uint32 newValue) external override onlyFromGovernance {
        uint32 prevValue = _consensusParams.candidateLength;
        _consensusParams.candidateLength = newValue;
    ...
    function getMaxDelegateTotalAmount() external view returns (uint256) {
        return _consensusParams.maxDelegateTotalAmount;
    }

    function setMaxDelegateTotalAmount(uint256 newValue) external override onlyFromGovernance {
        uint256 prevValue = _consensusParams.maxDelegateTotalAmount;
        _consensusParams.maxDelegateTotalAmount = newValue;
