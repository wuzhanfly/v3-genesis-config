...
func createGenesisConfig(config genesisConfig, targetFile string, updateOnlyConfig bool) error {
	...
	if genesis.Alloc == nil {
		...
		invokeConstructorOrPanic(genesis, chainConfigAddress, chainConfigRawArtifact, []string{"uint32", "uint32", "uint32", "uint32", "uint32", "uint32", "uint32", "uint256", "uint256", "uint256"}, []interface{}{
...
var localNetConfig = genesisConfig{
	...
	ConsensusParams: consensusParams{
		...
		CandidateLength:          51,                                                                    // suggested values are (3k+1, where k is honest validators, even better): 7, 13, 19, 25, 31...
		...
		MaxDelegateTotalAmount:   (*math.HexOrDecimal256)(hexutil.MustDecodeBig("0x1bc16d674ec800002")), // 1 ether
	},
