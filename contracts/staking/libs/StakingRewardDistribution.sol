...
contract StakingRewardDistribution is StakingStorageLayout, RetryMixin, IStakingRewardDistribution {
    ...
    function _undelegateFrom(address toDelegator, address fromValidator, uint256 amount) internal {
        // check amount is not zero and has a correct precision
        ...
        uint112(_STAKING_CONFIG_CONTRACT.getMinStakingAmount() / BALANCE_COMPACT_PRECISION),
        ...
        require(nextDelegatedAmount >= uint112(_STAKING_CONFIG_CONTRACT.getMinStakingAmount() / BALANCE_COMPACT_PRECISION),
            "unstake remainder is too low");
